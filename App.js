...
export default class InternalProfileScreen extends Component {
    ...
    return (
        ...
        <Text style={styles.Txt427}>
          Send us a referral for a weed killing guarantee!
        </Text>
        <Text style={styles.Txt932}>Logo Lawncare</Text>
        <Image
          style={styles.Star1}
          source={{
        ...
        />
        <Text style={styles.Txt744}>(56)</Text>
        <View style={styles.Group642}>
          ...
          <View style={styles.Group270}>
            <Image
              style={styles.Frame4}
              source={{
                uri: "https://work-together-app-icons.s3.amazonaws.com/mower.jpg",
              }}
            />
            <View style={styles.Group210}>
              <Image
                style={styles.FrameCustom}
                source={{uri: "https://work-together-app-icons.s3.amazonaws.com/lawn-care-grass-mower.jpg",}}
              />
            ...
            <View style={styles.Group400}>
              <Image
                style={styles.Frame6}
                source={{
                  uri: "https://work-together-app-icons.s3.amazonaws.com/lush-lawn.jpg",
                }}
              />
              <Image
                style={styles.Frame5}
                source={{
                  uri: "https://work-together-app-icons.s3.amazonaws.com/lawn.jpg",
                }}
              />
            </View>
          </View>
