...
export default class CarriesPassALead extends Component {
    render() {
        return (
            <View style={styles.container}>
              ...
              <Text style={{ color: 'chocolate', fontSize: 20  }}> Carrie's Carpet Cleaning</Text>
              ...
              <View style={styles.button}>
                <Button
                  title="send"
                  color="orange"
                  onPress={() => this.props.navigation.navigate('CarriesLeadSent')}
                />
              </View>
