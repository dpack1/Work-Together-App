...
export default class FavoritesScreen extends Component {
    render() {
      ...
      <View style={styles.PlusButtonView}>
        ...
        />
        <Text style={styles.Txt467}>88</Text>
        <Text style={styles.Txt451}>Nixit Handyman</Text>
        <Text style={styles.Txt81010}>89% of the leads they pass convert</Text>
        <Image
          style={styles.Star6}
          source={{
        ...
        />
        <Text style={styles.Txt312}>The Gutter Guy</Text>
        <Text style={styles.Txt1015}>40% of the leads they pass convert</Text>
        <Image
          style={styles.Star11}
          source={{
        ...
        />
        <Text style={styles.Txt144}>26</Text>
        <Image
        ...
        />
        <Text style={styles.Txt838}>Carrie’s Carpet Cleaning</Text>
        <Text style={styles.Txt1052}>67% of the leads they pass convert</Text>
        <Image
          style={styles.Star1}
          source={{
      ...
      />
      <Text style={styles.Txt544}>56</Text>
      <Text style={styles.Txt392}>Logo Lawncare</Text>
    </View>
        );
    }
}
