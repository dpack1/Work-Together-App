...
const Page_next_page  = ({navigation}) => {
	useEffect(() => {
	}, []);
	const onClick_image_55_container = () => {
					navigation.navigate("Page_next_page")
	}
	return (
	...
	<ScrollView bounces={false} showsVerticalScrollIndicator={false} style={{height: Dimensions.get("window").height}}>
		<Animated.View style={[{}, noneModeStyles._page1]}    >
			...
			<View style = {noneModeStyles._nav_bar_icons}    >
				<View style = {noneModeStyles._Nav_Icons}    >
			...
			<View style = {noneModeStyles._image_55_container}  onStartShouldSetResponder = {() => {return true}} onResponderGrant = {() => {}} onResponderRelease = {() => {onClick_image_55_container();}} onStartShouldSetResponderCapture = {() => true}>
			...
			<Text style = {noneModeStyles._layer_f82caa}   >
				expo install @expo-google-fonts/dev expo-font expo-app-loading
			</Text>
			<Text style = {noneModeStyles._layer_f245c6}   >
				expo install @expo-google-fonts/dev expo-font expo-app-loading
			</Text>
		</Animated.View>
	</ScrollView>
